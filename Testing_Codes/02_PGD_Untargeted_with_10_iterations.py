...
target_label = 94
targeted=False
att="02_PGD_Untargeted_with_10_iterations"
attack1=ProjectedGradientDescent(normalclassifier, targeted=targeted, max_iter=10, eps_step=1, eps=5)
attack2=ProjectedGradientDescent(betterclassifierwithoutrandom, targeted=targeted, max_iter=10, eps_step=1, eps=5)
attack3=ProjectedGradientDescent(betterclassifier, targeted=targeted, max_iter=10, eps_step=1, eps=5)
