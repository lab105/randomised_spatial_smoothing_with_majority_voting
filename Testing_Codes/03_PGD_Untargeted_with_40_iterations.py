...
target_label = 94
targeted=False
att="03_PGD_Untargeted_with_40_iterations"
attack1=ProjectedGradientDescent(normalclassifier, targeted=targeted, max_iter=40, eps_step=1, eps=5)
attack2=ProjectedGradientDescent(betterclassifierwithoutrandom, targeted=targeted, max_iter=40, eps_step=1, eps=5)
attack3=ProjectedGradientDescent(betterclassifier, targeted=targeted, max_iter=40, eps_step=1, eps=5)
