...
targeted=False
target_label=94
att="07_FGSM_Untargeted_with_1.0_eps"
attack1=FastGradientMethod(normalclassifier, eps=1.0)
attack2=FastGradientMethod(betterclassifierwithoutrandom, eps=1.0)
attack3=FastGradientMethod(betterclassifier, eps=1.0)
