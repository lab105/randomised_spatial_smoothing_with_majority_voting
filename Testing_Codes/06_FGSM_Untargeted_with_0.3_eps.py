...
targeted=False
target_label=94
att="06_FGSM_Untargeted_with_0.3_eps"
attack1=FastGradientMethod(normalclassifier, eps=0.3)
attack2=FastGradientMethod(betterclassifierwithoutrandom, eps=0.3)
attack3=FastGradientMethod(betterclassifier, eps=0.3)
